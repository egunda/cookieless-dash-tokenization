...
-----BEGIN PRIVATE KEY-----
MC4CAQAwBQYDK2VwBCIEIIxJm3gTSPWjk3FpA9fpRYg4Al2eNSS2S+hHuGO5/pkf
-----END PRIVATE KEY-----
`
...
func init() {
	...
	gcsOriginHost = getEnv("GCS_ORIGIN_HOST", "storage.googleapis.com/tearsofsteel11")
	mediaCDNHost = getEnv("MEDIA_CDN_HOST", "dual.vivekanurag.demo.altostrat.com")
